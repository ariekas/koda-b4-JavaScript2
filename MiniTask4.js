...
function out(c, cb1, cb2, cb3) {
  console.log("Hasil konversi Celsius " + c + " ke Fahrenheit adalah: " + cb1(c));
  console.log("Hasil konversi Celsius " + c + " ke reamur adalah: " + cb2(c));
  console.log("Hasil konversi Celsius " + c + " ke kelvin adalah: " + cb3(c));
  return;
}
